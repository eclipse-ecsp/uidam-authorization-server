...
public class DefaultAuditLogger implements AuditLogger {
    ...
    public void log(String eventType,
        ...
        try {
            ...
            log.error("Failed to save audit log: eventType={}, component={}", 
                eventType, component, e);
        }
    }
    ...
    public void log(String eventType,
        ...
        try {
            ...
            log.error("Failed to save audit log with message: eventType={}", 
                eventType, e);
        }
    }
    ...
    public void logFailure(String eventType,
        ...
        try {
            ...
            log.error("Failed to save audit failure log: eventType={}, failureCode={}", 
                eventType, failureCode, e);
        }
    }
